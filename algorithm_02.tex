...
A denoising process is performed before the clustering process. We use a total variation filter \reftodo{\comment{[chambolle]}}, to produce a smoother image, while maintaining the edges sharp. The Total Variation filter works by minimizing the integral of the norm of the image gradient. As a result of this filter, piecewise-constant images (``cartoon-like'' images) are obtained.
