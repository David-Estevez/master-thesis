...
When working with images, this clustering process of finding regions both compact and with homogeneous characteristics is known as segmentation. Many image segmentation algorithms exist based on similar regions and closed contours. One of this algorithms, widely used, is the Watershed transform algorithm \reftodo, which interprets the image as a topological surface, filling the image with water from several point sources until they merge, and creating walls in those intersection contours. Regions isolated by these walls are the segmented regions.
