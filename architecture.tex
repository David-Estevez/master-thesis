...
\begin{figure}[thpb]
    ...
    \caption{Garment Unfolding pipeline. The pipeline takes RGB and depth images from the robot sensors and process them in three consecutive stages. This process is iterative, and it is applied until the garment is fully unfolded.}
