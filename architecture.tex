...
\juansays{Furthermore, clustering preprocessing algorithms can also be used, with other classical segmentation algorithms such as Watershed \reftodo } \comment{[...]}
