...
\begin{figure}[t]
    ...
    \caption{This figure shows the experimental setup used to test our algorithm. The garment rests over a flat white table, with the RGB-D sensor on top. Besides the table, the humanoid robot TEO waits for manipulation trajectories that indicate it how to perform the unfold action.}
