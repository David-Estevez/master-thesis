...
\begin{document}
	\title{\textbf{\warning{Unfolding Clothes with a Robotic Slave}}}
   ...
   \warning{Thanks to the anonymous donnor of the lost red sweater, which was very useful in testing and debugging the algorithms of this work.}
