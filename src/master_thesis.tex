...
% Fix ugly urls
\newcommand{\stdurl}[1] { \urlstyle{same}\url{#1}, last accessed: \today. }

% Cool large table variables
\newcommand{\bigtablewidth}{0.49\textwidth}
\newcommand{\videofigurewidth}{0.41\textwidth}
...
\begin{document}
	...
	\tutor{Juan G. Victores}
  	\stutor{Carlos Balaguer}
        ...
        \primerjurado{Dr. Ramón Barber Castaño}
        \segundojurado{Dr. Santiago Martínez de la Casa Díaz}
        \thirdreader{Dr. Fernando Martín Monar}
