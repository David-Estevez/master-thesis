...
Finally, the european project CloPeMa (Clothes Perception and Manipulation), devoted to perception and manipulation of fabric, textiles and garments, is mentioned. Their most relevant \comment{(to our research)} work is explained in this last section.

\comment{Model-less(?) - Not sure where to put this}

\section{\juansays{Garment Modeling-Based Approaches}}
...
\begin{figure}[thpb]
    ...
    \caption{\comment{(Cusumano thing)}}
...
\begin{figure}[thpb]
    ...
    \caption{\warning{(This might look like a joke...because it is a joke)}}
